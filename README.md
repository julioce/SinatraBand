...
It's currently only supporting MySQL database. But it's actually pretty easy to change the default values on the generated database.rb. Take a look on ActiveRecord for help.
...
You can also create a model and it's following properties:
    ...
    $ sinatraband model model_name property1:activerecord_type property2:other_activerecord_type
